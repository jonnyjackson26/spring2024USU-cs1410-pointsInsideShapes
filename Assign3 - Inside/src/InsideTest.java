...
public class InsideTest {
    ...
    public void fIsPointInsideRectangle() {
        ...
        pointList.add(new Pair<>(new Pair<>(4.123, 5.234), false)); //errors
        ...
        pointList.add(new Pair<>(new Pair<>(3.2, -4.8), true)); //errors
        pointList.add(new Pair<>(new Pair<>(4.7, -4.8), true)); //errors
